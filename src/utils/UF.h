...
public:
    ...
    void MassUniforms(GLuint shader, int doReflections, int doFog, GLfloat ConeSI[], GLfloat ConeRot[], glm::vec3 lightPos, GLfloat fogRGBA[], GLfloat skyRGBA[], GLfloat lightRGBA[], float gamma);
};
