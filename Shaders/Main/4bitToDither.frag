...
void main()
{
    ...
    ivec2 bayerPos = ivec2(mod(gl_FragCoord.x, 4.0), mod(gl_FragCoord.y, 4.0));
    ...
    // Output the dithered color with the original alpha value
    FragColor = vec4(ditheredColor, texColor.a);
}
